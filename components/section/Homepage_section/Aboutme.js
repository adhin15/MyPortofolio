  ...
  return (
    <div id="about-me-section" className="pt-16">
      <div className="container p-8 w-full flex flex-wrap" >
        <h3 className="text-4xl w-full text-[#FF7700] font-bold">About Me</h3>
        <div className="md:w-2/3 w-full text-center p-4 ">
          <div className="">
            <img src="./assets/man-coding.png" className="h-[280px] m-auto object-cover" alt=""/>
